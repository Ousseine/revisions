 ...
 */
final class Version20210923015849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B9A1906012469DE2');
        $this->addSql('DROP INDEX IDX_B9A190604B89032C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__post_category AS SELECT post_id, category_id FROM post_category');
        ...
        $this->addSql('INSERT INTO post_category (post_id, category_id) SELECT post_id, category_id FROM __temp__post_category');
        $this->addSql('DROP TABLE __temp__post_category');
